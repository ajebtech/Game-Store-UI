      ...
      <div className="mb-16 md:mb-2 mx-5  flex">
        <div className=" relative w-[100%]   flex justify-between  ">
          ...
          <div className="flex items-center md:gap-1 ">
            <div className="flex z-20 hover:cursor-pointer w-[120px] h-9 gap-2 justify-center rounded-full  top-5 mt-1 items-center py-1 font-bold text-white text-base bg-blue-950 border-2 border-blue-500 transform transition-transform duration-500 hover:scale-110">
              <img
